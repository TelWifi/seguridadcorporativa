namespace Gromero.Seguridad.Windows.Usuarios
{
	partial class frmPromptUsuarios
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.usuarioInfoListBindingSource.DataSource = typeof(Gromero.Seguridad.Negocio.SoloLectura.UsuarioInfo);
			// 
			...
			this.gdvUsuarios.OptionsView.ShowButtonMode = DevExpress.XtraGrid.Views.Base.ShowButtonModeEnum.Default;
			// 
			// colCodigo
			// 
