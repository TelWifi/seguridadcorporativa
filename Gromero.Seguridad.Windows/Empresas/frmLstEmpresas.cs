...
namespace Gromero.Seguridad.Windows.Empresas
{
    public partial class frmLstEmpresas : _PlantillaGestor
    {
        ...
        public override void Eliminar()
        {
            ...
            try
            {
                ...
                Empresa.DeleteEmpresa(_Empresa.ID);
                Buscar();
            }
            catch (DataPortalException ex)
            {
